...
2. Compute the Mean Squared Shortest **Scaled** Distance (MSSSD) of the k-means sample. (use function `rdist` of library `fields` to compute a matrix with scaled distances between grid cells and the k-means sample; then use function `apply` to compute the shortest distance)   
