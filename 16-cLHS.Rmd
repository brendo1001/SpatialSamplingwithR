...
Note that in package `spsann` O1 is not computed as the sum of the absolute values of the stratum sample sizes minus 1, but as the mean. The final value of O1 in the `data.frame` `trace` equals `r trace$O1[nrow(trace)]`, which equals the value of O1 computed above as a sum, divided by the total number of marginal strata (100) and multiplied by the weight for O1 (0.5).
